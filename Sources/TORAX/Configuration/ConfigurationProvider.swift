...
///
/// Reads configuration overrides from environment variables with prefix "TORAX_"
/// Example: TORAX_MESH_NCELLS=200, TORAX_TIME_END=5.0
public struct EnvironmentConfigurationProvider: ConfigurationProvider {
    ...
    public init(prefix: String = "TORAX_") {
        self.prefix = prefix
    }
