// ToraxConfigReader.swift
// ConfigReader-based configuration loading for TORAX
...
public actor ToraxConfigReader {
    ...
    /// Reload configuration by creating a new ToraxConfigReader
    ///
    /// Note: ConfigReader doesn't have a reload() method. To reload configuration,
    /// you need to create a new ToraxConfigReader instance. For automatic reloading,
    ...
    @available(*, deprecated, message: "Use ToraxConfigReader.create() to reload configuration")
