...
print()
print("Next steps:")
print("  - Run actual simulation with: swift run GotenxCLI run --config Examples/Configurations/minimal.json --quit")
print("  - Test CLI overrides: swift run GotenxCLI run --config Examples/Configurations/minimal.json --mesh-ncells 200 --quit")
print("  - Test environment variables: GOTENX_MESH_NCELLS=150 swift run GotenxCLI run --config Examples/Configurations/minimal.json --quit")
print()
